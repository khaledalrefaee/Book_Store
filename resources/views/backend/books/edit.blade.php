                                                ...
                                                <div class="card card-primary">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="name" type="text" id="inputName" class="form-control"  value="{{ $book->name }}">
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input name="price" type="number" id="inputName" class="form-control" value="{{$book->price}}">
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="inputName">Book quantity </label>
                                                            <input   name="quantity" type="number" id="inputName" class="form-control" value="{{$book->quantity}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="inputName">auther </label>
                                                            <input name="author" type="text" id="inputName" class="form-control" value="{{$book->author}}">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input name="published_date" type="text" id="inputClientCompany" class="form-control" value="{{$book->published_date}}">
                                                        </div>
                                                        <div class="form-group">
...
{{--                                                                    <input class="custom-file-label" for="exampleInputFile" type="file" name="image" id="image" >Choose file</input>--}}
                                                                </div>
